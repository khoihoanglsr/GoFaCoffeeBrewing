...
namespace Latte_Art_GoFa
{
    public partial class Latte_Art_GoFa : Form
    {
        ...
        {
            InitializeComponent();
            Login_Window Login_Window = (Login_Window)Application.OpenForms["Login_Window"];
        ...
        private void tableLayoutPanel_RobotJoints_Paint(object sender, PaintEventArgs e)
        {
        ...
        private void label_RobotStatus_Click(object sender, EventArgs e)
        {

        }

        private void panel_RobotState_Paint(object sender, PaintEventArgs e)
        {

        }

        private void panel_ControllerState_Paint(object sender, PaintEventArgs e)
        {

        }

        private void label_Notconnected1_Click(object sender, EventArgs e)
        {

        }

        private void label_Notconnected2_Click(object sender, EventArgs e)
        {

        }

        private void tableLayoutPanel_TCPPos_Paint(object sender, PaintEventArgs e)
        {
