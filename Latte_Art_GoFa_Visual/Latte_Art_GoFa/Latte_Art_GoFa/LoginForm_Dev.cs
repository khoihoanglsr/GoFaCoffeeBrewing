    ...
    namespace Latte_Art_GoFa
    {
        ...
        public partial class loginWindow : Form
        {
            ...
            public loginWindow()
            {
                ...
                buttonLoginAdmin.Enabled = false;
                buttonLoginDefaultUser.Enabled = false;
            ...
            private void comboBoxControllers_SelectedIndexChanged(object sender, EventArgs e)
            {
                ...
                ControllerInfo selectedInfo = (ControllerInfo)combo_Box_Controllers.SelectedItem;   //sort the info of the selected controller from the box
                ...
                {
                    buttonLoginAdmin.Enabled = true;
                    buttonLoginDefaultUser.Enabled = true;
                }
            ...
            private void ButtonLoginAdmin_Click(object sender, EventArgs e)
            {
                ...
                if (textBoxUsername.Text == AdminUsername && textBoxPassword.Text == AdminPassword)
                {
